...
function OnToggleGEFProgressPanel()
    Controls.DiploList:SetHide(true)
    Controls.ProgressPanel:SetHide(not Controls.ProgressPanel:IsHidden())
end
LuaEvents.OnToggleGEFProgressPanel.Add(OnToggleGEFProgressPanel)